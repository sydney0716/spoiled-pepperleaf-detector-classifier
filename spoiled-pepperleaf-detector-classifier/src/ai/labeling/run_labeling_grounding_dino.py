...
INTERIM_DETECTION_DIR = PROJECT_ROOT / "data/interim/detection"
OUTPUTS_DIR = INTERIM_DETECTION_DIR / "labeled_images/grounding_DINO"

DEFAULT_IMAGE_DIR = PROJECT_ROOT / "data/processed/detection/images"

DEFAULT_ANNOTATIONS_DIR = OUTPUTS_DIR
DEFAULT_VISUALIZATIONS_DIR = OUTPUTS_DIR / "visualizations"

MODEL_CONFIG_PATH = PROJECT_ROOT / "weights/pretrained/GroundingDINO_SwinT_OGC.py"
MODEL_CHECKPOINT_PATH = PROJECT_ROOT / "weights/pretrained/groundingdino_swint_ogc.pth"
