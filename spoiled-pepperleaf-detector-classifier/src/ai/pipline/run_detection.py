#!/usr/bin/env python3
"""
Run the trained YOLOv8n detector on a directory of Korean pepper leaf images.

The script expects the best weights produced by `train_detection_yolo.py` to be
stored under `weights/trained/best_yolov8n.pt`. Only directory arguments are
exposed: one for the source images and one for where the YOLO run artifacts
should be written.
"""
...
DEFAULT_WEIGHTS = PROJECT_ROOT / "weights/trained/best_yolov8n.pt"
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / "results/detection/runs"
