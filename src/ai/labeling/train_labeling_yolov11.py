...
DEFAULT_COCO_JSON = (
    REPO_ROOT / "data/interim/detection/labeled_images/hand-reviewed_afterDINO(230)/_annotations.coco.json"
)
DEFAULT_IMAGE_ROOT = REPO_ROOT / "data/processed/detection/images"
DEFAULT_DATASET_ROOT = (
    REPO_ROOT / "data/interim/detection/labeled_images/hand-reviewed_afterDINO(230)/yolov11_split"
)
DEFAULT_PROJECT_ROOT = REPO_ROOT / "results/detection/labeling_yolo11s"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Destination directory where the YOLO-formatted split should be written.",
    )
    parser.add_argument(
        "--project-dir",
        type=Path,
...
def main() -> None:
    ...
    dataset_root = (args.dataset_dir or DEFAULT_DATASET_ROOT).resolve()
