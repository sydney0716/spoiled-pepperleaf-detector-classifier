#!/usr/bin/env python3
"""
Run the trained ResNet18 classifier on a directory of pepper leaf crops.

The script expects `leaf_classifier_resnet18.pth` produced by
`classification/train_resnet.py` to live under `weights/trained/`. Provide an
input directory of RGB images (individual leaves or patches) and it will print
the predicted class plus confidence for each file.
"""
...
DEFAULT_WEIGHTS = PROJECT_ROOT / "weights/trained/leaf_classifier_resnet18.pth"
IMAGE_EXTENSIONS = (".jpg", ".jpeg", ".png", ".bmp", ".tif", ".tiff")
CLASS_LABELS = ["normal", "spoiled"]


def build_model(num_classes: int = 2) -> nn.Module:
    """Recreate the ResNet18 head used during training."""
